    ...
    for per in permutations_list:
        ...
        while len(order) > 0:
            ...
            if current_person in current_tenants:
                ...
                while cycle_house in owner.keys() and owner[cycle_house] not in sequence:
            ...
            if not cycle_found:
                if house_wanted not in owner or assignment[owner[house_wanted]] is not None or owner[house_wanted] == current_person:
...
def testTPL01():
    ...
    print housing_assignments[(p1, p2, p3)]
...
def testTPL02():
    ...
    statistics_count, housing_assignments = TPL(persons, houses, owner, preferences)
    print housing_assignments[(p1, p2, p3, p4)]
